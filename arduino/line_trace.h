 ...
 * =================================================
 */
#define OPT_SPEED 120         // 기본 주행 속도 (PWM: 0~255)
#define TURN_SPEED 100        // 기본 회전 속도 (PWM: 0~255)
#define TURN_SPEED_SLOW 100   // 회전 시 감속 속도
...
void turn_left();
void turn_right();
void align_to_line(int alignment_side, int direction); // 라인 정렬 함수
